...
Original file is located at
    https://colab.research.google.com/drive/1cMn1tErsosMnaT3v6Kl3kJvgbEryiB47
"""
...
try:
    ...
    st.error("Błąd: Nie znaleziono kluczy API. Skonfiguruj 'Secrets' w panelu Streamlit.")
    st.stop()

# Połączenie z bazą (z cache, żeby nie łączyć się przy każdym kliknięciu)
@st.cache_resource
def init_connection():
...
if menu == "Stan Magazynu":
    ...
    if unikalne_towary:
        wybor = st.selectbox("Wybierz towar do usunięcia", unikalne_towary)
        ...
        st.warning("Brak towarów do wydania.")